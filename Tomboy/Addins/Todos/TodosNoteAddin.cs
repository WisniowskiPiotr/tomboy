// Add an Todos item to the font styles menu. Just select text and press ctrl+e.
...
{
	public class TodosNoteAddin : NoteAddin
	{
        /// <summary>
		...
		{
            //this.Manager.
            // if (!Note.TagTable.IsDynamicTagRegistered(TodosTag.TagName))
            // {
            //     Note.TagTable.RegisterDynamicTag(TodosTag.TagName, typeof(TodosTag));
            // }
        }
		...
		public override void OnNoteOpened ()
		{
			...
			//AddTextMenuItem (new TodosMenuItem (this));
		}
	}
}
